...
extension ConstantSizeVector {
        ...
        public static var zero: Self {
            return Self(
                components: [ComponentType](
                    repeating: Self.ComponentType.zero, count: Self.numberOfComponents))
        }

        public var numberOfComponents: Int { return Self.numberOfComponents }

        public static var dimensions: IntSize {
            return IntSize(rows: Self.numberOfComponents, columns: 1)
        }
        ...
        public static var zero: Self {
            return Self(
                components: [ComponentType](
                    repeating: Self.ComponentType.zero, count: Self.staticNumberOfComponents))
        }

        public var numberOfComponents: Int { return Self.staticNumberOfComponents }

        public static var staticDimensions: IntSize {
            return IntSize(rows: Self.staticNumberOfComponents, columns: 1)
        }
        ...
        public init(repeating value: ComponentType) {
            self.init(
                components: [ComponentType](repeating: value, count: Self.staticNumberOfComponents))
        }
    #endif
