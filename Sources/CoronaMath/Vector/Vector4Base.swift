...
where VectorType: DiscreteNumber {
    ...
    // MARK: - Static Properties
        ...
        public private(set) var components: [VectorType] = [VectorType](
            repeating: VectorType.zero, count: Vector4Base.numberOfComponents)
    #else
        ///The number of components in a `Vector4Base` instance.
        ...
        ///The values of the vector.
        public private(set) var components: [VectorType] = [VectorType](
            repeating: VectorType.zero, count: Vector4Base.staticNumberOfComponents)
    #endif

    ///The unit vector in the x direction.
    public static var unitX: Vector4Base<VectorType> {
        return Vector4Base<VectorType>(components: [
            VectorType.one, VectorType.zero, VectorType.zero, VectorType.zero,
        ])
    }
    ///The unit vector in the y direction.
    public static var unitY: Vector4Base<VectorType> {
        return Vector4Base<VectorType>(components: [
            VectorType.zero, VectorType.one, VectorType.zero, VectorType.zero,
        ])
    }
    ///The unit vector in the z direction.
    public static var unitZ: Vector4Base<VectorType> {
        return Vector4Base<VectorType>(components: [
            VectorType.zero, VectorType.zero, VectorType.one, VectorType.zero,
        ])
    }
    ///The unit vector in the w direction.
    public static var unitW: Vector4Base<VectorType> {
        return Vector4Base<VectorType>(components: [
            VectorType.zero, VectorType.zero, VectorType.zero, VectorType.one,
        ])
    }
...
extension Vector4Base: ContinuousVector, ConstantSizeContinuousVector
...
private enum Vector4BaseCodingKeys: CodingKey {
    case x
    case y
    case z
    case w
